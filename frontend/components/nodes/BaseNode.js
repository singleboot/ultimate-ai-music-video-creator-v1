    ...
    <>
      ...
      <div
        style={{
          ...
          border: `1px solid ${isRunning ? color : 'rgba(176,38,255,0.3)'}`,
          borderRadius: 16,
          color: '#fff',
          minWidth: 220,
          maxWidth: 300,
      ...
      {hasInput &&
        Array.from({ length: inputCount }).map((_, i) => {
          const pos =
            inputPositions && inputPositions[i]
              ? inputPositions[i]
              : Position.Top;
          const left =
            inputCount === 1
          ...
          return (
            <Handle
              ...
              style={{
                ...
                top: pos === Position.Top ? -5 : undefined,
                bottom: pos === Position.Bottom ? -5 : undefined,
                left: pos === Position.Left ? -5 : undefined,
                right: pos === Position.Right ? -5 : undefined,
      ...
      {hasOutput &&
        Array.from({ length: outputCount }).map((_, i) => {
          const pos =
            outputPositions && outputPositions[i]
              ? outputPositions[i]
              : Position.Bottom;
          const left =
            outputCount === 1
